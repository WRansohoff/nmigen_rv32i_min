...
It is fairly simple, with no I-cache, timers, or configurable interrupts. But it can read programs out of SPI Flash, and it has one peripheral for basic GPIO and four for driving 'neopixel' LEDs.

Currently it uses about 95% of the logic cells in an `iCE40UP5K`, but it seems to work. I'm hoping to make it smaller so that it can also fit a debugging interface and some more LED peripherals.
